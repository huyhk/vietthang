    ...
    public class HelperSetting
    {
        public static HelperSetting FromConfig()
        {
            ...
            try
            {
                ...
                setting.dataBits = int.Parse(ConfigurationManager.AppSettings["DataBit"].ToString());
                setting.dataPatern = ConfigurationManager.AppSettings["DataPattern"].ToString();
            }
            catch
            { }
            return setting;
        ...
        private string endOfLine = "00000";
        ...
        public string DataPatern
        {
            get { return dataPatern; }
            set { dataPatern = value; }
        }
    }
}
