...
namespace VNS.Scales.Helper
{
    public class ScaleHelper
    {
        ...
        {
            Regex reg = new Regex(config.EndOfLine); //Regex(@"[" + config.EndOfLine + "]+");
            //Regex reg = new Regex(@"00000");
            //Write2Log.WriteLogs("Helper", "ProcessData", _data);
            if (reg.IsMatch(_data))
            {
                ...
                //Write2Log.WriteLogs("Helper", "ProcessData Match", _data);
            }
            //OnDataReceived(_data);    
