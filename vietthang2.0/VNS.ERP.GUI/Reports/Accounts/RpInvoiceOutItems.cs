...
{
    public partial class RpInvoiceOutItems : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void BindData()
        {
           ...
           // this.lbTittle.Text += " (" + this.param.thueSuat.ToString() + "%)";
            ...
            cellTenNguoiMua.DataBindings.Add("Text", this.DataSource, "TenNguoiMua");
