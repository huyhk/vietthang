...
{
    public partial class RpAccountTransactionAmounDetail : ReportBase1
    {
        ...
        public RpAccountTransactionAmounDetail()
        {
            InitializeComponent();
        ...
        public void BindData()
        {
            ...
            cellInAmount.DataBindings.Add("Text", this.DataSource, "InCostAmount", AppConfigs.CONFIG_AMOUNTVNFORMAT_STRING);
            ...
            cellOutAmount.DataBindings.Add("Text", this.DataSource, "OutCostAmount", AppConfigs.CONFIG_AMOUNTVNFORMAT_STRING);
