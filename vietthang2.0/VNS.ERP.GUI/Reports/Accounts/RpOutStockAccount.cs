...
namespace VNS.ERP.GUI
{
    ...
    public partial class RpOutStockAccount: XtraReport
    {
        int STT = 0;
        ...
        public void BindData()
        {
           ...
           // celSLTXN.DataBindings.Add("Text", this.DataSource, "Quantity", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            ...
            this.lblBangchu.Text = NumberConvert.NumberToSentence(RpParam.TotalAmount, false, "đồng");
