...
{
    public partial class RpInOutMaterial2 : ReportBase1
    {
        public RpInOutMaterial2()
        {
            InitializeComponent();
        }
         /// <summary>
        ...
        public RpInOutMaterial2(object dataSource, DateTime startDate, DateTime endDate)
        {
        ...
        private void LoadData()
        {
            ...
            CellItemType.DataBindings.Add("Text", this.DataSource, "ItemTypeName");
            ...
            cellOpenQuantityType.DataBindings.Add("Text", this.DataSource, "OpenQuantity", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellOpenQuantityType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellNhapMuaType.DataBindings.Add("Text", this.DataSource, "NhapMua");
            cellNhapMuaType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellNhapNBType.DataBindings.Add("Text", this.DataSource, "NhapNB", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellNhapNBType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellNhapSoCheType.DataBindings.Add("Text", this.DataSource, "NhapSoChe", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellNhapSoCheType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellNhapKhacType.DataBindings.Add("Text", this.DataSource, "NhapKhac", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellNhapKhacType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellXuatSXType.DataBindings.Add("Text", this.DataSource, "XuatSX", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellXuatSXType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellXuatNBType.DataBindings.Add("Text", this.DataSource, "XuatNB", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellXuatNBType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellXuatSoCheType.DataBindings.Add("Text", this.DataSource, "XuatSoChe", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellXuatSoCheType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellXuatBanType.DataBindings.Add("Text", this.DataSource, "XuatBan", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellXuatBanType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellXuatKhacType.DataBindings.Add("Text", this.DataSource, "XuatKhac", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellXuatKhacType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellDeltaStockType.DataBindings.Add("Text", this.DataSource, "DeltaStock", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellDeltaStockType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
            ...
            cellCloseQuantityType.DataBindings.Add("Text", this.DataSource, "CloseQuantity", AppConfigs.CONFIG_QUANTITYFORMAT_STRING);
            cellCloseQuantityType.Summary.FormatString = AppConfigs.CONFIG_QUANTITYFORMAT_STRING;
