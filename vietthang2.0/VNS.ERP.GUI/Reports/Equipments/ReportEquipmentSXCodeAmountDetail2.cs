...
{
    public partial class ReportEquipmentSXCodeAmountDetail2 : ReportBase1
    {
        object lstDatasource;
        public ReportEquipmentSXCodeAmountDetail2()
        {
            InitializeComponent();
        }
        public ReportEquipmentSXCodeAmountDetail2(string periodText, string stockName, string line, string equipmentSXName, DataTable dt)
        {
            InitializeComponent();
