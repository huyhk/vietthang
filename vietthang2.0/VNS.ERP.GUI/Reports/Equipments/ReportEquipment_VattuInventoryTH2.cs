...
{
    public partial class ReportEquipment_VattuInventoryTH2 : ReportBase1
    {
        object lstDatasource;
        public ReportEquipment_VattuInventoryTH2()
        {
            InitializeComponent();
        }
        public ReportEquipment_VattuInventoryTH2(string periodText, DataTable dt)
        {
            InitializeComponent();
