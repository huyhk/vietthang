...
{
    public partial class ReportEquipment_VattuInventory_OldTH1 : ReportBase1
    {
        object lstDatasource;
        public ReportEquipment_VattuInventory_OldTH1()
        {
            InitializeComponent();
        }
        public ReportEquipment_VattuInventory_OldTH1(string periodText, DataTable dt)
        {
            InitializeComponent();
