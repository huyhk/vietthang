...
{
    public class MixPremixTransaction : UserTracking2
    {
        public MixPremixTransaction()
        { }
        public MixPremixTransaction(DbDataReader Reader)
        {
        ...
        public override void LoadFromReader(DbDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!CheckNull("MixPremixID", reader)) _mixPremixID = reader.GetGuid(reader.GetOrdinal("MixPremixID"));
